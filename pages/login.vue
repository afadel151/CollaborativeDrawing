...
const signInWithOAuth = async () => {
  const { data, error } = await supabase.auth.signInWithOAuth({
    provider: 'google',
    options: {
      redirectTo: 'https://collaborative-drawing-git-main-afadel151s-projects.vercel.app/dialog', // Ensure this matches your Supabase settings
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="text-center">
      ...
      <button
        ...
        class="inline-flex items-center justify-center bg-red-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-red-700 transition-colors"
      >
